...
import "./styles.css"; // Import your CSS if needed

const FireworkShow = () => {
    useEffect(() => {
        const scriptUrls = [
            "https://s3-us-west-2.amazonaws.com/s.cdpn.io/329180/fscreen@1.0.1.js",
            "https://s3-us-west-2.amazonaws.com/s.cdpn.io/329180/Stage@0.1.4.js",
    ...
    return (
        <div className="fixed w-full h-full bg-transparent top-0 left-0 z-[-99]">
            {/* SVG Spritesheet */}
            {/* <ParticlesComponent /> */}
            ...
            <div className="w-full h-full bg-transparent fixed top-0 left-0 z-0">
                ...
                <div className="stage-container remove">
                    <div className="canvas-container">
                        <canvas id="trails-canvas" className="bg-transparent "></canvas>
                        <canvas id="main-canvas" className="bg-transparent "></canvas>
                    </div>
