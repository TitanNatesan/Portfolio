...
export default function AboutSection() {
    return (
        <section id="about" className="section about-section" aria-label="About Titan Natesan">
            ...
            <div className="section-content">
                ...
                <button className="cta-button secondary starry-btn" onClick={() => document.getElementById('projects')?.scrollIntoView({ behavior: 'smooth' })} aria-label="Navigate to projects section">
